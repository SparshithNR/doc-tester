...
function parseFile(fileName) {
  ...
  if (fileExtension == '.md') {
    ...
    let codeLines = codeArray.reduce((lastValue, element) => {
      return checkDupAndAddToList(lastValue, element.value.split('\n'));
    }, []);
...
module.exports = { parseFile, parseImport, getAssertionComponenets, getCode, getAssertion, executeTests, checkDupAndAddToList };
